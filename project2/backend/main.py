...
@app.post("/api/herdsmen/", response_model=schemas.Herdsman, status_code=201)
...
@app.get("/api/herdsmen/", response_model=List[schemas.Herdsman])
...
@app.get("/api/herdsmen/{herdsman_id}", response_model=schemas.Herdsman)
...
@app.put("/api/herdsmen/{herdsman_id}", response_model=schemas.Herdsman)
...
@app.delete("/api/herdsmen/{herdsman_id}", response_model=schemas.Herdsman)
...
@app.post("/api/profile/", response_model=schemas.Profile, status_code=201)
...
@app.post("/api/acquisitions/", response_model=schemas.Acquisition, status_code=201)
...
@app.get("/api/acquisitions/", response_model=List[schemas.Acquisition])
...
@app.get("/api/acquisitions/{acquisition_id}", response_model=schemas.Acquisition)
...
@app.put("/api/acquisitions/{acquisition_id}", response_model=schemas.Acquisition)
...
@app.delete("/api/acquisitions/{acquisition_id}", response_model=schemas.Acquisition)
...
@app.post("/api/announcements/", response_model=schemas.Announcement, status_code=201)
...
@app.get("/api/announcements/{announcement_id}", response_model=schemas.Announcement)
...
@app.delete("/api/announcements/{announcement_id}", response_model=schemas.Announcement)
