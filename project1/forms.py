...
from wtforms import StringField, DecimalField, TextAreaField, SubmitField, PasswordField, IntegerField
...
class FarmerForm(FlaskForm):
    ...
    milk_station_id = IntegerField('所属奶站编号', validators=[DataRequired()])
