...
cd project2/backend
start cmd /k "python -m pip install -r requirements.txt && python -m uvicorn main:app --reload --port 8000"
cd ../..
...
cd project1/backend
start cmd /k "python -m pip install -r requirements.txt && python app.py"
cd ../..
